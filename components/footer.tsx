...
export default function Footer() {
  return (
      <footer className='xl:w-fit w-[95%] mx-auto xl:hidden flex flex-col items-center text-center italic text-xl md:py-5 py-3 md:px-10 px-0 font-bold rounded-2xl text-foreground/50 border border-orange my-5'>
